...
zend_module_entry ocqprint_module_entry = {
	...
	PHP_RINIT(ocqprint),		/* Replace with NULL if there's nothing to do at request start */
	PHP_RSHUTDOWN(ocqprint),	/* Replace with NULL if there's nothing to do at request end */
	PHP_MINFO(ocqprint),
#if ZEND_MODULE_API_NO >= 20010901
...
PHP_FUNCTION(qprint)
{
	...
	php_error(E_WARNING, "qprint: not yet implemented");
}
/* }}} */
